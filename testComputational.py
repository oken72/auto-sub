...
def main(argv):
    if argv[1] == "-shortTerm":
        ...
        for i in range(nExp):
            ...
            perTime1 = duration / (t2 - t1)
            print(
                "Mid-term feature extraction + classification \t {0:.1f} x realtime".format(perTime1))
        ...
        for i in range(nExp):
            ...
            perTime1 = duration / (t2 - t1)
            print(
                "Fix-sized classification - segmentation \t {0:.1f} x realtime".format(perTime1))
        ...
        for i in range(nExp):
            ...
            perTime1 = duration / (t2 - t1)
            print(
                "HMM-based classification - segmentation \t {0:.1f} x realtime".format(perTime1))
